---
name: openapi-dotnet
description: This is a skill for using OpenAPI specification to define API contracts and generate code for backend projects. You can use this skill to maintain consistency in API contracts and automate code generation based on the defined API contracts.
---
# OpenAPI Usage
